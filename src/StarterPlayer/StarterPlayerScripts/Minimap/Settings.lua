...
--[[
		...
		["Gui"] = { --This is all the settings for the Guis. (This is more advanced! Please don't touch if you're not experienced!)
			...
			["anchorPoint"] = Vector2.new(1,1); --This is the anchorpoint for the map gui.
			["mapPosition"] = UDim2.new(1,-5,1,-200); --This is the position of the map. "anchorPoint" will have an effect on the position.
		...
		["Map"] = {
			["mapId"] = 8185285758; --The textureid for the map.
			["size"] = Vector2.new(804, 768); --The size of the map in studs.
			["mapCenter"] = Vector3.new(0,0,0)
		};
		
		["Technical"] = { --This is some technical settings.
			["onePixel"] = .5; --This is what one pixel is in studs.
